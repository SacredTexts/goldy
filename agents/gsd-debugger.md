...
```bash
INIT=$(node /Users/forest/.claude/get-shit-done/bin/gsd-tools.cjs state load)
...
```bash
node /Users/forest/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
